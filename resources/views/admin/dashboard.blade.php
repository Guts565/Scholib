...
<body>
                ...
                <tr>
                    ...
                    <td>
                        <div class="button-group pt-2">
                            <a href="{{ url('/admin/edit/' . $student->nim) }}"
                                class="btn btn-primary rounded-4 me-2">Edit</a>
                            <form class="ml-2" action="{{ url('/admin/delete/' . $student->nim) }}" method="POST">
                                @csrf
                                @method('DELETE')
    ...
    <a href="{{ url('/admin/users/') }}" class="btn btn-primary ms-3">Edit Akun</a>
    <a href="{{ url('/admin/logout/') }}" class="btn btn-primary ms-3">log out</a>
</body>
