    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-4 mt-4">
                {{-- <h2>User ID: {{ $studentdata->user_id }}</h2> --}}
                <form action="{{ '/admin/update/' . $studentdata->nim }}" method="post">
                    @csrf
                    {{-- <div class="mb-3">
                        <label for="nama" class="form-label">Nama:</label>
                        <input class="form-control" type="text" id="nama" name="nama"
                            value="{{ $studentdata->nama }}" readonly>
                    </div>

                    <div class="mb-3">
                        <label for="nim" class="form-label">NIM:</label>
                        <input class="form-control" type="text" id="nim" name="nim"
                            value="{{ $studentdata->nim }}" readonly>
                    </div>

                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Jurusan:</label>
                        <input class="form-control" type="jurusan" id="jurusan" name="jurusan"
                            value="{{ $studentdata->jurusan }}" readonly>
                    </div>

                    <div class="mb-3">
                        <label for="jk" class="form-label">Jenis Kelamin:</label>
                        <input class="form-control" type="jk" id="jk" name="jk"
                            value="{{ $studentdata->jk }}" readonly>
                    </div> --}}
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="tahunAjaran" id="tahunAjaran" name="tahunAjaran"
                            value="{{ $studentdata->tahunAjaran }}" readonly>
         </div> --}}

                    <div class="mb-3">
                        <label for="ipk" class="form-label">IPK:</label>
                        <input class="form-control" type="ipk" id="ipk" name="ipk"
                            value="{{ $studentdata->ipk }}" readonly>
                    </div>
