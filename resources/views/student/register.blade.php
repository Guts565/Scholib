...
<head>
    <title>Register Data pribadi</title>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-4 mt-4">
                <form action="/student/store" method="post">
                    ...
                    <button class="btn btn-primary rounded-4" type="submit">Register</button>
                    <a href="/loggedin"><input class="btn btn-primary rounded-4" type="button" value="Back"></a>
                </form><br><br>
                @if (session('error'))
