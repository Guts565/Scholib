...
use App\Http\Middleware\RedirectIfAuthenticated; // Add this line
...
Route::get('/home', [HomeController::class, 'index'])->name('home')->middleware(['auth', RedirectIfAuthenticated::class]);
